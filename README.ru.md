...
- [Playwright MCP](https://github.com/microsoft/playwright-mcp) — обязателен для UI-прогонов скилла `testing`: водит браузер, снимает сетевые payload. Демо из README без него не заведётся.
